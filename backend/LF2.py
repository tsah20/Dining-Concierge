...
def get_dynamo_data(dynno, table, key):
    response = table.get_item(Key={'id':key}, TableName='yelp-restaurants2')
...
def lambda_handler(event, context):
    es_host = 'https://search-restaurants2-xqt3bqq5fplztqekgfhoji5wgy.us-east-1.es.amazonaws.com/restaurants2'
    ...
    for message in messages:
        ...
        phone_number = '+1'+ msg_attributes['phone_number']
